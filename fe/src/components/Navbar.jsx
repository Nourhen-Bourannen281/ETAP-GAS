...
import {
  ...
  faCreditCard,
  faBell,
  faHome,           // 🏠 Pour vente locale
  faOilCan          // 🛢️ Pour cabotage (pétrole)
        ...
        <nav className="sidebar-nav">
          ...
          {role === 'Admin' && (
            <>
              ...
              <Link to="/export" className={`sidebar-link ${isActive('/export')}`}>
              ...
              {/* ✅ Vente Locale - Icône faHome (représente la vente locale) */}
              <Link to="/vente-locale" className={`sidebar-link ${isActive('/vente-locale')}`}>
                <FontAwesomeIcon icon={faHome} />
                <span>Vente Locale</span>
              </Link>

              {/* ✅ Cabotage - Icône faOilCan (représente le pétrole) */}
              <Link to="/cabotage" className={`sidebar-link ${isActive('/cabotage')}`}>
